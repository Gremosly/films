...
<body>	
	...
	<div class="container">
        ...
        <div class="form_add_content">
            <h2 class="admin_panel">Панель администратора(Добавление сериала)</h2>
			...
			<form action="" method="post">
                ...
                <input class="filmName" type="text" name="serialName" placeholder="Название сериала" value="<?php echo $serialName; ?>"/>
